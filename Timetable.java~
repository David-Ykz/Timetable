...
public class Timetable {
    ...
    //adders/setters
    public void addRoom(int roomId, String roomNum, String roomName) {
        this.rooms.put(roomId, new Room(roomId, roomNum, roomName));
    }
    
    public void addTeacher(int teacherId, String teacherName, String teacherQualification) {
        this.teachers.put(teacherId, new Teacher(teacherId, teacherName, teacherQualification));
    }
